...
const advantages = [
  ...
  // {
  //   id: 6,
  //   title: "Современная инфраструктура и цифровые технологии",
  //   description:
  //     "Интерактивные аудитории, IT-кластеры, юридические симуляционные залы. Онлайн-библиотеки, исследовательские базы данных и специализированное ПО.",
  // },
  {
    id: 7,
  ...
  // {
  //   id: 9,
  //   title: "Участие в международных ивентах и конкурсах",
  //   description:
  //     "Конференции, бизнес-форумы, юридические симуляции, хакатоны, стартап-инкубаторы. Встречи с ведущими специалистами и участие в реальных проектах.",
  // },
];
